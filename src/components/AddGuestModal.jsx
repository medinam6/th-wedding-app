...
import { titleOptions, stateOptions, countryOptions, formatPhoneNumber } from './guestListUtility';
...
const AddGuestModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const totalInParty = getTotalPartySize();
  ...
  return (
    ...
    <div className="mt-8">
        ...
        {/* Collapsible Content */}
            <div
              className={`transition-all duration-200 overflow-hidden ${
                showContact ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="space-y-4 pt-1 pl-1 py-1 pr-1">
                <div className="grid grid-cols-2 gap-4">
