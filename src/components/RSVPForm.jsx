...
const RSVPForm = () => {
                                    ...
                                    <div className="mt-10 flex justify-center">
                                        <div className="w-full sm:max-w-md">
                                            <div className="mt-2">
                                                ...
                                                {isSearchSubmitted && searchResults.length < 1 ? (<span className="text-xs text-center-aligned text-gray-500">Hm... we can't find your name. Make sure you enter your name exactly as it appears on your invitation.</span>) : (null)}
                                            </div>
                                        </div>
                                    </div>
    ...
    const renderRSVPForm = () => (
        <div className="mt-8 space-y-6" >
            ...
            <form onSubmit={(e) => {
                ...
                <h2 className="text-xl text-white font-pop font-heavy text-center pb-5">RSVP for Your Party</h2>
                <hr style={{ borderTop: '1px solid gray' }}></hr>
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            {selectedParty && !submitted && (
                isEditing || needsToRSVP(selectedParty) ? (
                    renderRSVPForm()
                ) : (
                    renderConfirmation()
                )
