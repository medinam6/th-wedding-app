...
const OurStory = () => <div class="max-w-3xl mx-auto">
  ...
  {/* <Image src="/DSC06780.jpeg" alt="A meaningful description" width={500} height={300} /> */}
  <p class="font-bodo text-md mb-4 text-black pt-5">
    ...
    {/* <Image src="/DSC06785.jpeg" alt="A meaningful description" width={500} height={300} /> */}
    <p class="font-bodo text-md mb-4 text-black pt-5">
    ...
    {/* <Image src="/DSC06727.jpeg" alt="A meaningful description" width={500} height={300} /> */}
    ...
    {/* <Image src="/DSC06742.jpeg" alt="A meaningful description" width={500} height={300} /> */}
