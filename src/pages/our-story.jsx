...
const OurStory = () => (
  <div class="max-w-3xl mx-auto text-center">
    <h1 class="font-bodo text-4xl font-bold text-center mb-6 p-6">
      Our Story, as told by the groom
    </h1>
    <div class="bg-white p-6">
      ...
      <p class="font-bodo text-md mb-4 text-black pt-5">
        ...
        understanding. She embraced my world—concerts with bands she’d never heard of, watching me
        play drums with admiration in her eyes—and I found myself wanting to experience everything
        through her lens. My family saw how she lit up my life, and hers welcomed me with open arms.
        When I proposed in Portland last April, every detail carried meaning, a reflection of the
        depth of what we share. She was overwhelmed, speechless for a moment—but in her eyes, I saw
      ...
      <p class="font-bodo text-md text-black pt-5 pb-5">
        I never imagined marriage for myself, but then I met her. She is my greatest adventure, my
        unwavering support, my home. Together, we dream of traveling the world, growing old side by
        side, and pushing each other to become the best versions of ourselves. We are like oil and
        water in so many ways, but love has made us inseparable. She is my heart, my happiness, my
        forever.
      </p>
      <div class="flex justify-center">
